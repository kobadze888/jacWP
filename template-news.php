...
$page_title = ($current_lang == 'ka') ? 'ჯაკის სიახლეები' : 'Jac News';
$load_more_text = ($current_lang == 'ka') ? 'მეტის ჩატვირთვა' : 'Load More';

$paged = (get_query_var('paged')) ? get_query_var('paged') : 1;
$news_query = new WP_Query(array(
    'post_type' => 'post',
    'posts_per_page' => 9, // საწყისი 9 სიახლე
    'paged' => $paged
));
?>
        ...
        <div class="news-archive-grid" id="newsArchiveGrid">
            ...
            if($news_query->have_posts()):
                while($news_query->have_posts()): $news_query->the_post();
                    // აქაც ვიძახებთ იგივე საერთო ქარდს
                    get_template_part('template-parts/card', 'news');
                endwhile; 
            else:
                echo '<p style="text-align:center; width:100%; grid-column: 1 / -1;">სიახლეები არ მოიძებნა.</p>';
            endif; 
            ?>
        </div>
