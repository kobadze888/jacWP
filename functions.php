...
function jac_enqueue_scripts()
{
    ...
    // FontAwesome CSS 6.5.1 გლობალურად
    ...
    /* 4. sunray MODEL SECTION */
    // sunray Model გვერდის სტილები
    if (is_page_template('models/page-sunray.php')) {
        wp_enqueue_style('jac-sunray.css', get_template_directory_uri() . '/assets/css/models/sunray.css', array(), '1.0');
    ...
    /* 6. js6 MODEL SECTION */
    // js6 Model გვერდის სტილები
    if (is_page_template('models/page-js6.php')) {
        wp_enqueue_style('jac-js6.css', get_template_directory_uri() . '/assets/css/models/js6.css', array(), '1.0');
