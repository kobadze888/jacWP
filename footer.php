...
<footer class="footer">
        ...
        <div class="footer-col">
            ...
            <div class="footer-links">
                <?php if (has_nav_menu('footer_col_1')) {
                    wp_nav_menu(array('theme_location' => 'footer_col_1', 'container' => false, 'depth' => 1));
                } ?>
            </div>
        </div>
        ...
        <div class="footer-col">
            ...
            <div class="footer-links">
                <?php if (has_nav_menu('footer_col_3')) {
                    wp_nav_menu(array('theme_location' => 'footer_col_3', 'container' => false, 'depth' => 1));
                } ?>
            </div>
        </div>
        ...
        <div class="footer-col">
            ...
            <div class="footer-links">
                <?php if (has_nav_menu('footer_col_4')) {
                    wp_nav_menu(array('theme_location' => 'footer_col_4', 'container' => false, 'depth' => 1));
                } ?>
            </div>
        </div>
    ...
    <div class="footer-bottom">
        ...
        <div class="footer-counter">
            ...
            <div id="top-ge-counter-container" data-site-id="101261"></div>
